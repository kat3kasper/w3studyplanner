...
% Version:	$Id: ic_global.ecl,v 1.1.1.1.4.6 2011/09/09 08:36:38 kish_shen Exp $
%
%
...
:- comment(date, "$Date: 2011/09/09 08:36:38 $").
...
<P>
    ...
    together. The alldifferent constraint used is the liv(ic_global) version.
