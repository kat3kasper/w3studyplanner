...
testBlankSchedule:-
	okDegree([
		...
		degreeReq('SCIENCE REQUIRED COURSES 3', ch115,[]),
		degreeReq('SCIENCE REQUIRED COURSES 3', ch281, []),

		degreeReq('MATH REQUIRED COURSES', ma115, []),
		degreeReq('MATH REQUIRED COURSES', ma116, []),
		degreeReq('MATH REQUIRED COURSES', ma222, []),
		degreeReq('MATH REQUIRED COURSES', ma331, []),

		degreeReq('INFORMATION SYSTEMS ELECTIVES', bt244, []),

		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs115, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs146, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs135, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs284, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs334, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs383, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs385, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs347, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs392, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs496, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs442, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs511, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs488, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs492, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs506, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs423, []),
		degreeReq('COMPUTER SCIENCE REQUIRED COURSES', cs424, []),

		degreeReq('TECHNICAL ELECTIVES', ssw553, []),
		degreeReq('TECHNICAL ELECTIVES', none, A),

		degreeReq('SOFTWARE DEVELOPMENT ELECTIVES', none, B),

		degreeReq('MATH SCIENCE ELECTIVES', none, C),
		degreeReq('MATH SCIENCE ELECTIVES', none, D),

		degreeReq('FREE ELECTIVES', none, E),
		degreeReq('FREE ELECTIVES', none, F),

		degreeReq('HUMANITIES GROUP A', none, G),
		degreeReq('HUMANITIES GROUP A', none, H),

		degreeReq('HUMANITIES GROUP B', none, I),
		degreeReq('HUMANITIES GROUP B', none, J),

		degreeReq('HUMANITIES UPPER LEVEL', hss371, []),

		degreeReq('HUMANITIES UPPER LEVEL', none, K),
		degreeReq('HUMANITIES UPPER LEVEL', none, L),
		degreeReq('HUMANITIES UPPER LEVEL', none, M)
		], 
		[]),	
	writeln("Sem1":Sem1),
	writeln("Sem2":Sem2),
